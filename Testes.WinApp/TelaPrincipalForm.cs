...
namespace Testes.WinApp
{
    public partial class TelaPrincipalForm : Form
    {
        ...
        private void InicializarControladores()
        {
            ...
            controladores.Add("Matérias", new ControladorMateria(repositorioMateria)); //controladorMateria
            //controladores.Add("Questao", new ControladorContato(repositorioContato));
